...
from .models import Ingredient, IngredientInRecipe, Recipe, Tag, Favorited, ShoppingCart
...
class RecipeReadSerializer(serializers.ModelSerializer):
    ...
    ingredients = IngredientInRecipeSerializer(source='inginrecipe', many=True, read_only=True)
...
class RecipeWriteSerializer(serializers.ModelSerializer):
    ...
    def add_nested_data(self, ingredients, recipe):
        ...
        for ing in ingredients:
            inginrecipe_objs.append(IngredientInRecipe(
                recipe=recipe,
